...
CREATE TABLE "new_bot_settings" (
    ...
    "trailing_max_x" REAL NOT NULL DEFAULT 5.0,
    "updated_at" DATETIME NOT NULL
);
INSERT INTO "new_bot_settings" ("chat_id", "delayed_entry_enabled", "delayed_entry_mcap", "exit_mode", "max_portfolio_sol", "robinhood_enabled", "slippage_bps", "stop_loss_pct", "take_profit_pct", "trade_size_sol", "trading_mode", "updated_at") SELECT "chat_id", "delayed_entry_enabled", "delayed_entry_mcap", "exit_mode", "max_portfolio_sol", "robinhood_enabled", "slippage_bps", "stop_loss_pct", "take_profit_pct", "trade_size_sol", "trading_mode", "updated_at" FROM "bot_settings";
